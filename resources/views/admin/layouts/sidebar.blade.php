            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    @if($user_type == $admin)
                 <li>
                      <a><i class="fa fa-hospital-o"></i> Mahasiswa <span class="fa fa-chevron-down"></span></a>
                 ...
                 <li>
                      ...
                      <ul class="nav child_menu">
                        @if($user_type == $admin)
                      <li class="{{Route::currentRouteName()=='students-list' ? 'active' : ''}}"><a href="{{Route('students-list')}}"><i class="fa fa-building-o"></i> Semua Mahasiswa </a></li>
                        @endif
                        @if($user_type == $teacher)
                      <li class="{{Route::currentRouteName()=='getTeacherStudentsListPage' ? 'active' : ''}}"><a href="{{Route('getTeacherStudentsListPage')}}"><i class="fa fa-building-o"></i> List Mahasiswa </a></li>
                        @endif
                    ...
                    @if($user_type == $admin || $user_type == $teacher)
                 <li>
                      <a><i class="fa fa-building-o" aria-hidden="true"></i> Jenis Peminatan <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                      <li class="{{Route::currentRouteName()=='departments-list' ? 'active' : ''}}"><a href="{{Route('departments-list')}}"><i class="fa fa-list-alt" aria-hidden="true"></i> Peminatan </a></li>
                      </ul>
                 </li>
                    @endif
                 <li>
                      <a><i class="fa fa-columns"></i> Matkul <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                      @if($user_type == $teacher || $user_type == $admin)
                      <li class="{{Route::currentRouteName()=='courses-list' ? 'active' : ''}}"><a href="{{Route('courses-list')}}"><i class="fa fa-list-alt"></i> Semua Matkul </a></li>
                      @endif
                      @if($user_type == $admin)
                      ...
                      @endif
                      @if($user_type == $teacher)
                      <li class="{{Route::currentRouteName()=='my-courses-list' ? 'active' : ''}}"><a href="{{Route('my-courses-list')}}"><i class="fa fa-list-alt"></i> My Matkul </a></li>
                      @endif
                     @if($user_type == $student)
                      <li class="{{Route::currentRouteName()=='student-courses-list' ? 'active' : ''}}"><a href="{{Route('student-courses-list')}}"><i class="fa fa-list-alt"></i> Semua Matkul </a></li>
                      <li class="{{Route::currentRouteName()=='logged-student-courses-list' ? 'active' : ''}}"><a href="{{ route('logged-student-courses-list') }}"><i class="fa fa-list-alt"></i> My Matkul </a></li>
                     @endif
                      </ul>
                 </li>
                    @if($user_type == $teacher)
                <li>
                    <a><i class="fa fa-file-text-o"></i> Materi Matkul <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li class="{{Route::currentRouteName()=='course-lessons-list' ? 'active' : ''}}"><a href="{{Route('course-lessons-list')}}"><i class="fa fa-list-alt"></i> List Materi </a></li>
                    </ul>
                </li>
                    @endif
                    @if($user_type == $teacher)
