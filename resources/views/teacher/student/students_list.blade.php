        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('certifyStudent') }}" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="logo_image" id="f_logo_image">
                    ...
                    <div class="modal-body">
                        <div style="width:863px; height:600px; padding:20px; text-align:center; border: 10px solid #787878">
                            <div style="width:807px; height:550px; padding:20px;  border: 5px solid #787878">
                                <div style="text-align:justify;">
                                    <img src="/admin/images/logo/images.png" alt="Logo" id="logoImage" style="text-align: left;height: 70px;width: 70px;">
                                </div>
                                <div style="text-align:center; line-height:1.2;">
                                    ...
                                    <span style="font-size:25px"><i>has completed the lab course</i></span> <br/><br/>
...
@section('page_js')
    <script>
        ...
        $('#certificateModal').on('show.bs.modal', function (e) {
            $('#f_logo_image').val($(e.relatedTarget).data('logo_image'));
            ...
            $("#logoImage").attr("src",$(e.relatedTarget).data('logo_image'));
        });
